...
export default function Ref({ url, alt, image, title, subtitle, badges, tooltip }: RefProps) {
    ...
    return (
        <div className="group">
            ...
            <Component {...(params as any)} className="block group rounded-3xl outline-4 outline-offset-4 outline-transparent hover:outline-[#a5a5a58f] transition-colors hover:animate-boom relative">
