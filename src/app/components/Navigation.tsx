...
export function Navigation() {
    ...
    return (
        <div
            className={`fixed top-0 left-0 right-0 bg-surface/80 transition-transform backdrop-blur-md z-40 ${scrolled && !isMenuOpen ? "-translate-y-full" : "translate-y-0"}`}
        ...
        >
            <nav className="text-inky container pt-3.5 pb-2.5 flex gap-16 items-center max-lg:justify-between" data-test="nav-bar">
                ...
                <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="bg-white rounded-3xl h-8 px-3 cursor-pointer z-20 lg:hidden" data-test="nav-menu-toggle">
