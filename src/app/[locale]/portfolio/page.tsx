...
export default function Portfolio() {
    ...
    return (
        <div className="container" data-test="portfolio-page">
            <div className="pt-40 mb-20" data-test="portfolio-experience-section">
                <h2 dangerouslySetInnerHTML={{ __html: t("experience") }} className="h2" data-test="portfolio-experience-heading"></h2>
                <div className="ml-[30%] md:ml-[40%]" data-test="portfolio-experience-list">
                ...
                before:duration-700 hover:text-white transition-colors duration-700 before:scale-x-215 before:bg-gradient-to-r before:from-inky before:from-50% before:to-50% before:to-white hover:before:translate-x-full"
                        data-test="portfolio-cv-download"
                    >
            ...
            <div data-test="portfolio-certificates-section">
                <h2 dangerouslySetInnerHTML={{ __html: t("certs") }} className="h2" data-test="portfolio-certificates-heading"></h2>
                <Certificates />
            </div>
            <div data-test="portfolio-projects-section">
                <h2 dangerouslySetInnerHTML={{ __html: t("projects") }} className="h2" data-test="portfolio-projects-heading"></h2>
                <div className="grid lg:grid-cols-3 md:grid-cols-2 mb-14 gap-6 gap-y-20" data-test="portfolio-projects-grid">
